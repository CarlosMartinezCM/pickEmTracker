...
const initialPlayers: Player[] = [
 {
    name: "Carlos Comish",
    picks: ["TB","SEA","CLE","ATL","MIN","NYG","JAX","HOU","BUF","CHI","DEN","LV","LAR","NE","PHI","BAL"],
    tiebreaker: 40,
  },
  {
    name: "Eric Rodriguez",
    picks: ["TB","SF","CIN","ATL","MIN","DAL","JAX","HOU","BUF","CHI","DEN","KC","LAR","NE","PHI","PIT"],
    tiebreaker: 36,
  },
  {
    name: "Nik",
    picks: ["CAR","SEA","CLE","ATL","GB","DAL","JAX","HOU","BUF","CHI","DEN","KC","LAR","NE","PHI","BAL"],
    tiebreaker: 35,
  },
  {
    name: "Yolo",
    picks: ["CAR","SF","CIN","ATL","GB","DAL","JAX","HOU","BUF","CHI","LAC","KC","LAR","NE","PHI","BAL"],
    tiebreaker: 32,
  },
  {
    name: "J Rios",
    picks: ["TB","SEA","CIN","ATL","MIN","DAL","JAX","HOU","BUF","CHI","DEN","KC","LAR","NE","PHI","BAL"],
    tiebreaker: 48,
  },
  {
    name: "J El De La R",
    picks: ["CAR","SF","CIN","NO","MIN","DAL","JAX","HOU","BUF","CHI","LAC","KC","LAR","NE","PHI","PIT"],
    tiebreaker: 45,
  },
  {
    name: "Fay",
    picks: ["TB","SEA","CIN","NO","GB","DAL","TEN","HOU","BUF","CHI","DEN","KC","LAR","NE","PHI","PIT"],
    tiebreaker: 48,
  },
  {
    name: "Edgar B",
    picks: ["TB","SF","CIN","ATL","MIN","DAL","JAX","HOU","BUF","DET","LAC","KC","LAR","MIA","PHI","BAL"],
    tiebreaker: 41,
  },
  {
    name: "Javier",
    picks: ["CAR","SEA","CIN","ATL","MIN","DAL","JAX","HOU","BUF","CHI","DEN","KC","LAR","NE","PHI","PIT"],
    tiebreaker: 48,
  },
  {
    name: "Oso",
    picks: ["CAR","SEA","CLE","NO","GB","NYG","JAX","IND","BUF","DET","DEN","KC","LAR","MIA","PHI","PIT"],
    tiebreaker: 53,
  },
  {
    name: "Rios",
    picks: ["TB","SF","CIN","ATL","GB","DAL","JAX","IND","BUF","DET","LAC","LV","LAR","NE","PHI","BAL"],
    tiebreaker: 50,
  },
  {
    name: "Erick Escobar",
    picks: ["CAR","SEA","CIN","ATL","MIN","DAL","JAX","HOU","BUF","CHI","DEN","KC","LAR","NE","PHI","BAL"],
    tiebreaker: 42,
  },
  {
    name: "Sumo",
    picks: ["TB","SEA","CIN","ATL","GB","DAL","JAX","HOU","BUF","CHI","DEN","KC","LAR","NE","PHI","PIT"],
    tiebreaker: 49,
  },
  {
    name: "Bobby",
    picks: ["CAR","SF","CIN","ATL","GB","DAL","JAX","HOU","BUF","CHI","DEN","KC","LAR","NE","PHI","BAL"],
    tiebreaker: 43,
  },
  {
    name: "Beto",
